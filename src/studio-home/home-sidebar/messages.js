...
const messages = defineMessages({
  aboutTitle: {
    ...
    defaultMessage: "¿Eres nuevo en {studioName}?",
  },
  aboutDescription: {
  ...
  sidebarDescription2: {
    ...
    defaultMessage:
      "In order to create courses in {studioName}, you must {mailTo}",
  },
  ...
  sidebarDescription4: {
    ...
    defaultMessage:
      "Your request to author courses in {studioName} has been denied. Please {mailTo}.",
  },
