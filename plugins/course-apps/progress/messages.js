...
const messages = defineMessages({
  ...
  enableProgressHelp: {
    ...
    defaultMessage: `A medida que los estudiantes completen las tareas 
    calificadas, las puntuaciones aparecerán en la pestaña de progreso. 
    Esta pestaña contiene una tabla con todas las tareas calificadas 
    del curso, junto con una lista de todas las tareas y sus puntuaciones.`,
  },
  enableProgressLink: {
