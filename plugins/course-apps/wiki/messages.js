...
const messages = defineMessages({
  ...
  enableWikiHelp: {
    ...
    defaultMessage: `La wiki del curso se puede configurar según 
    las necesidades del mismo. Algunos usos comunes incluyen compartir 
    respuestas a las preguntas frecuentes del curso, compartir información 
    editable del curso o proporcionar acceso a recursos creados por los estudiantes.`,
  },
  enableWikiLink: {
  ...
  enablePublicWikiHelp: {
    ...
    defaultMessage: `Si está habilitada, cualquier usuario registrado puede ver 
    la wiki del curso aunque no esté matriculado en él.`,
  },
});
